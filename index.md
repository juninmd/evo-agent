...
<section class="reports-band" id="relatorios">
  ...
  <div class="story-grid featured-grid">
    <article class="story-card">
      ...
      <h3><a href="https://juninmd.github.io/evo-agent/reports/weekly-2026-05-25-agentes-producao-mcp-padrao-declinio-engenharia-prompt">Relatorio Semanal: Agentes em Producao, MCP como Padrao, e o Declinio da Engenharia de Prompt Tradicional</a></h3>
    </article>
  </div>
</section>
  ...
  <section class="month-group">
    ...
    <div class="story-grid">
      ...
      <article class="story-card">
        ...
        <div class="chips"><span>homologacao</span><span>reddit</span><span>community-signals</span></div>
      </article>
    </div>
  </section>
</section>
